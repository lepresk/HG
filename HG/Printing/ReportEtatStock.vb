...
Public Class ReportEtatStock
    ...
    Sub RefreshReport()
        ...
        Try
            ...
            adapter.Fill(ds.StockActuelle)

            Report.LocalReport.ReportPath = System.Environment.CurrentDirectory & "\reports\ReportStockActuelle.rdlc"

            Dim paramLogo As New ReportParameter("rptLogo", "File:\" & My.Settings.logo)
            Dim paramTitre As New ReportParameter("rptTitre", titre)
            Dim paramPoint As New ReportParameter("rptPointVente", point_vente)
            ...
            With Report
                ...
                .LocalReport.DataSources.Add(New ReportDataSource("DataSetTables", CType(ds.StockActuelle, DataTable)))
                .RefreshReport()
            End With
